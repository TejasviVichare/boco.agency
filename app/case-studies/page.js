  ...
  return (
    <div className='w-full pt-32 '>
      ...
      <div className='md:px-32'>
       <p className='text-2xl text-left mt-7' style={{color:'#140152'}}>We've worked with nearly 100 brands in different modes and capacities over the years. Here's a few of our favorite success stories.</p>
      </div>
       <CaseStudies />
